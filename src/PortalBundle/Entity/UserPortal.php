...
class UserPortal
{
     ...
     * Add setting
     *
     * @param \CalendarBundle\Entity\Settings $setting
     *
     * @return UserPortal
     */
    public function addSetting(\CalendarBundle\Entity\Settings $setting)
    {
     ...
     * @param \CalendarBundle\Entity\Settings $setting
     */
    public function removeSetting(\CalendarBundle\Entity\Settings $setting)
    {
